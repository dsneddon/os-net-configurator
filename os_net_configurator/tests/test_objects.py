...
class TestSubnet(base.TestCase):
    ...
    def test_Subnet(self):
        ...
        self.assertEquals("192.168.2.1/23", subnet2.address(0))
        self.assertEquals("192.168.3.254", subnet2.gateway)
        self.assertEquals("192.168.3.0/23", subnet2.address(255))
        self.assertRaises(ValueError, subnet2.address, 511)
        self.assertEquals("192.168.3.254/23", subnet2.address(-1))
    ...
    def test_Subnet_range(self):
        ...
        self.assertEquals("192.168.2.10/23", subnet2.address(0))
